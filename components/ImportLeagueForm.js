...
export default function ImportLeagueForm({ userId }) {
  ...
  const handleTeamSelection = (e, teamName) => {
    ...
    getLeagueData(leagueId, selectedTeamId, leagueName, selectedProvider, selectedFormat);
  ...
  if (step === 'initial') {
    return (
      <div className="mx-auto max-w-sm bg-white p-5 px-8 w-[22rem] rounded-lg shadow-md h-[37rem]">
        <div>
