...
function HubBlock ({data}){

  return (
    <div className="col-span-2 text-myblue bg-gray-50 rounded-md font-bold shadow-sm overflow-hidden mt-2 mx-2 p-4">
      <span>DATA CALL ID: {data.id}</span>
      ...
      <span className=' mx-1'><a href="/api/auth/login">Login</a></span>
    </div>
  )
}
